...
func (o *ContentStringReader) Read(_ *TypeItem, reader *ReaderIO) (ret interface{}, err error) {
...
func (o *ContentArrayReader) Read(_ *TypeItem, reader *ReaderIO) (ret interface{}, err error) {
	//each character as a byte
	var data []byte
